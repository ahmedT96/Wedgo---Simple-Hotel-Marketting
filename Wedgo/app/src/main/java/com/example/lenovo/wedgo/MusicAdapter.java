...
public class MusicAdapter extends RecyclerView.Adapter<MusicAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder myViewHolder, final int position) {
        //final String readdesc = musicData.get(position).getMusic_band_description();
        ...
        myViewHolder.readdesc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myViewHolder.readdesc.setText(musicData.get(position).getMusic_band_description());
...
*/
        ...
        myViewHolder.textview.setText(musicData.get(position).getSinger_name());
        Glide.with(context).load(musicData.get(position).getMusic_band_img()).into(myViewHolder.imageView);
        ...
        final Music infoData = musicData.get(position);
...
*/
    ...
    private void removeItem(Music infoData) {

        int currPosition = musicData.indexOf(infoData);
        musicData.remove(currPosition);
        notifyItemRemoved(currPosition);
    }

    // This method adds(duplicates) a Object (item ) to our Data set as well as Recycler View.
    private void addItem(int position, Music infoData) {

        musicData.add(position, infoData);
