    ...
    public void onBindViewHolder(final MyViewHolder myViewHolder, final int position) {
        ...
        myViewHolder.readdesc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myViewHolder.readdesc.setText(carData.get(position).getCar_description());
...
*/
        ...
        myViewHolder.textview.setText(carData.get(position).getCar_model());
        Glide.with(context).load(carData.get(position).getCar_img()).into(myViewHolder.imageView);
        ...
        final Car infoData = carData.get(position);
...
*/
    ...
    private void removeItem(Car infoData) {

        int currPosition = carData.indexOf(infoData);
        carData.remove(currPosition);
        notifyItemRemoved(currPosition);
    }

    // This method adds(duplicates) a Object (item ) to our Data set as well as Recycler View.
    private void addItem(int position, Car infoData) {

        carData.add(position, infoData);
